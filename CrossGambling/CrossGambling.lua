        ...
        if (#self.game.result.losers > 0 and #self.game.result.winners > 0) then
            ...
            for i = 1, #self.game.result.losers do
                ...
                if (self.game.house == false) then
                    RollNotification = "Raidmist owes " .. self.game.result.winners[i].name .. " " .. add_commas(self.game.result.amountOwed) .. " gold!"
                elseif (self.game.house == true) then
                    RollNotification = "Raidmist owes " .. self.game.result.winners[i].name .. " " .. add_commas(self.game.result.amountOwed) .. " gold!" .. " plus " .. add_commas(houseAmount) .. " to the guild"
